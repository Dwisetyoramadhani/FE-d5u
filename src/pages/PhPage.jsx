        ...
        <div className="bg-white text-red-800">
            ...
            <div className="container mx-auto px-4 py-1">
                ...
                <div
                    ...
                    >
                    <div
                        className="w-full h-full text-white bg-gradient-to-r from-red-400 to-red-800"
                        style={{
            ...
            <section className="relative pb-14">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between mb-6">
                        <h2 className="text-xl sm:text-2xl font-extrabold text-red-700">Potret Kegiatan</h2>
                        <div className="hidden sm:block w-40 h-10 bg-gradient-to-r from-red-400 to-red-600 rounded-tl-2xl" />
                    </div>
                    {/* Gallery Grid */}
